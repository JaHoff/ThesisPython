...
filename = datafolder + "propagationHistory_0_fullprop.dat"
t, x1, y1, z1, vx1, vy1, vz1, m1  = DI.ImportPropagationHistory(filename,1, True)
...
PF.Simple3DPlot(x0, y0, z0, title='Orbit without planet propagation', 
...
PF.Simple3DPlot(x1, y1, z1, title='Orbit with planet propagation', 
                savefig = False, figfolder = '', name = 'placeholder.png', 
                xlabel = 'x [km]', ylabel = 'y [km]', zlabel='z [km]',
                xmod = 1000., ymod = 1000., zmod = 1000., xlim = None, 
                ylim = None , zlim = None,
